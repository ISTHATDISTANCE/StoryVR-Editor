const STORY_PROFILES = Object.freeze({
  shark: Object.freeze({
    ...
    instructions: Object.freeze({
      ...
      "dynamic-geometry": () => "Preview the saved shark movement. Add movement only when a scene needs it.",
      "inter-beat-dynamics": () => "Check the shark movement and every route through both choice sections.",
      "interaction-control": () => "Most story parts use buttons. In the opening story part, readers can grab and resize a white shark.",
  ...
  classroom: Object.freeze({
    ...
    instructions: Object.freeze({
      "source-graph": ({ beatCount }) => `Check ${beatCount} story parts in order, from closed windows to safer ventilation.`,
      ...
      "interaction-control": () => "Readers use the Previous and Next buttons through the classroom explanation.",
      "transition-pacing": ({ beatCount }) => `Review all ${beatCount} story parts in order and test Previous and Next once.`,
    }),
  ...
  transmission: Object.freeze({
    ...
    instructions: Object.freeze({
      "source-graph": ({ beatCount }) => `Check ${beatCount} story parts in order, from the cough to the distance lesson.`,
      ...
      "inter-beat-dynamics": () => "Check cough, droplet reveal, and camera timing between story parts.",
      "interaction-control": () => "Readers use the Previous and Next buttons through the distance explanation.",
      "transition-pacing": ({ beatCount }) => `Review all ${beatCount} story parts, check droplet timing, and test Previous and Next once.`,
    }),
...
const DEFAULT_INSTRUCTIONS = Object.freeze({
  ...
  "inter-beat-dynamics": () => "Check how one story part changes into the next.",
